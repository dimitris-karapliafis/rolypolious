...
@click.option('--format', default='svg', type=click.Choice(['svg', 'png']), help='format')
...
@click.option('--style', default='linear', type=click.Choice(['linear', 'circular']), help='style')
def visualize(input, output,   log_file, log_level, format, width, height, annotations, style):
    """
