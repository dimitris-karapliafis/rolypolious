...
@click.option("-o", "--output", default=lambda: f"{os.getcwd()}_virus_characteristics", help="Path to a tsv to save the summmary info of a RolyPoly run")
@click.option("-t", "--threads", default=1, help="Number of threads")
@click.option("-g", "--log-file", default=lambda: f"{os.getcwd()}/summarise_logfile.txt", help="Path to log file")
