    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if return_bibtex:
                ...
                authors = ' and '.join([f"{author['family']}, {author['given']}" for author in data['author']])
                title = data['title'][0]
...
def remind_citations(tools: Union[str, List[str]], return_as_text=False, return_bibtex=False):
